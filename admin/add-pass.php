...
<option value="">Choose Type Of Pass you Want.</option>
<option value="Voter Card">Passenger Daily Pass(Only PMC Area)</option>
<option value="PAN Card">Passenger Daily Pass(Only PMC & PCMC Area)</option>
<option value="Adhar Card">Senior Citizen’s Daily Pass Circulation</option>
<option value="Student Card">Passenger Monthly Pass(Only PMC Area)</option>
<option value="Driving License">Passenger Monthly Pass(Only PMC & PCMC Area)</option>
<option value="Passport">Senior Citizen’s Monthly Pass Circulation</option>
<option value="Any Official Card">Passenger’s 22-Day Punching Pass</option>
<option value="Any Official Card">Students Monthly Pass(All Route)</option>
<?php 
